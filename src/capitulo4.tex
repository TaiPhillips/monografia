...
dimensões \sigla{HWC}{\emph{Height X Width X Channel}, algura X largura X
canal} (largura, altura e canais de cor). Todos os frames de um mesmo vídeo
...
Para um detector com dimensões \sigla{HW}{\emph{Height X width}, algura X
