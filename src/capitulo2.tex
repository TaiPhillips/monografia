...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.6]{ex_fcnn.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.6]{cap2_conv_block.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.6]{ex_maxpool.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.9]{ex_cnn.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.7]{ex_classif_logist.png}
